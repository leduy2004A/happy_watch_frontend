          ...
          <div class="flex justify-content-between mb-3">
            <div>
              ...
              <div class="text-900 font-medium text-xl">
                {{ formatCurrency(thongKeHomNay.tongDoanhThu) }}
              </div>
            </div>
            <div
          ...
          <div class="grid">
            <div class="col-3">
              ...
              <div class="text-900 font-medium">
                {{ thongKeHomNay.tongSoLuongSanPhamDaBan }}
              </div>
            </div>
            <div class="col-3">
              <span class="text-500 font-medium">Đơn thành công</span>
              <div class="text-900 font-medium">
                {{ thongKeHomNay.tongSoLuongHoaDonHoanThanh }}
              </div>
            </div>
            <div class="col-3">
              <span class="text-500 font-medium">Đơn hủy</span>
              <div class="text-900 font-medium">
                {{ thongKeHomNay.tongSoLuongHoaDonHuy }}
              </div>
            </div>
            <div class="col-3">
              <span class="text-500 font-medium">Đơn trả</span>
              <div class="text-900 font-medium">
                {{ thongKeHomNay.tongSoLuongHoaDonTraHang }}
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="surface-card shadow-2 p-3 border-round">
          <div class="flex justify-content-between mb-3">
            <div>
              ...
              <div class="text-900 font-medium text-xl">
                {{ formatCurrency(thongKeTuanNay.tongDoanhThu) }}
              </div>
            </div>
            <div
          ...
          <div class="grid">
            <div class="col-3">
              <span class="text-500 font-medium">Sản phẩm</span>
              <div class="text-900 font-medium">
                {{ thongKeTuanNay.tongSoLuongSanPhamDaBan }}
              </div>
            </div>
            <div class="col-3">
              <span class="text-500 font-medium">Đơn thành công</span>
              <div class="text-900 font-medium">
                {{ thongKeTuanNay.tongSoLuongHoaDonHoanThanh }}
              </div>
            </div>
            <div class="col-3">
              <span class="text-500 font-medium">Đơn hủy</span>
              <div class="text-900 font-medium">
                {{ thongKeTuanNay.tongSoLuongHoaDonHuy }}
              </div>
            </div>
            <div class="col-3">
              <span class="text-500 font-medium">Đơn trả</span>
              <div class="text-900 font-medium">
                {{ thongKeTuanNay.tongSoLuongHoaDonTraHang }}
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="surface-card shadow-2 p-3 border-round">
          <div class="flex justify-content-between mb-3">
            <div>
              ...
              <div class="text-900 font-medium text-xl">
                {{ formatCurrency(thongKeThangNay.tongDoanhThu) }}
              </div>
            </div>
            <div
          ...
          <div class="grid">
            <div class="col-3">
              <span class="text-500 font-medium">Sản phẩm</span>
              <div class="text-900 font-medium">
                {{ thongKeThangNay.tongSoLuongSanPhamDaBan }}
              </div>
            </div>
            <div class="col-3">
              <span class="text-500 font-medium">Đơn thành công</span>
              <div class="text-900 font-medium">
                {{ thongKeThangNay.tongSoLuongHoaDonHoanThanh }}
              </div>
            </div>
            <div class="col-3">
              <span class="text-500 font-medium">Đơn hủy</span>
              <div class="text-900 font-medium">
                {{ thongKeThangNay.tongSoLuongHoaDonHuy }}
              </div>
            </div>
            <div class="col-3">
              <span class="text-500 font-medium">Đơn trả</span>
              <div class="text-900 font-medium">
                {{ thongKeThangNay.tongSoLuongHoaDonTraHang }}
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="surface-card shadow-2 p-3 border-round">
          <div class="flex justify-content-between mb-3">
            <div>
              ...
              <div class="text-900 font-medium text-xl">
                {{ formatCurrency(thongKeTheoNam.tongDoanhThu) }}
              </div>
            </div>
            <div
          ...
          <div class="grid">
            <div class="col-3">
              <span class="text-500 font-medium">Sản phẩm</span>
              <div class="text-900 font-medium">
                {{ thongKeTheoNam.tongSoLuongSanPhamDaBan }}
              </div>
            </div>
            <div class="col-3">
              <span class="text-500 font-medium">Đơn thành công</span>
              <div class="text-900 font-medium">
                {{ thongKeTheoNam.tongSoLuongHoaDonHoanThanh }}
              </div>
            </div>
            <div class="col-3">
              <span class="text-500 font-medium">Đơn hủy</span>
              <div class="text-900 font-medium">
                {{ thongKeTheoNam.tongSoLuongHoaDonHuy }}
              </div>
            </div>
            <div class="col-3">
              <span class="text-500 font-medium">Đơn trả</span>
              <div class="text-900 font-medium">
                {{ thongKeTheoNam.tongSoLuongHoaDonTraHang }}
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="grid">
    ...
    <div class="col-12">
      <div class="card">
        ...
        <Chart type="line" :data="allOrdersData" :options="chartOptions" />
      </div>
    </div>
...
const fetchData = async () => {
  try {
    ...
    doanhThu.value = [
      thongKeHomNay.value.tongDoanhThu,
      thongKeTuanNay.value.tongDoanhThu,
      thongKeThangNay.value.tongDoanhThu,
      thongKeTheoNam.value.tongDoanhThu,
    ];
    donHoanThanh.value = [
      thongKeHomNay.value.tongSoLuongHoaDonHoanThanh,
      thongKeTuanNay.value.tongSoLuongHoaDonHoanThanh,
      thongKeThangNay.value.tongSoLuongHoaDonHoanThanh,
      thongKeTheoNam.value.tongSoLuongHoaDonHoanThanh,
    ];
    trangThaiDonHang.value = [
      thongKeTheoNam.value.tongSoLuongHoaDonHoanThanh,
      thongKeTheoNam.value.tongSoLuongHoaDonHuy,
      thongKeTheoNam.value.tongSoLuongHoaDonTraHang,
    ];
    donHuy.value = [
      thongKeHomNay.value.tongSoLuongHoaDonHuy,
      thongKeTuanNay.value.tongSoLuongHoaDonHuy,
      thongKeThangNay.value.tongSoLuongHoaDonHuy,
      thongKeTheoNam.value.tongSoLuongHoaDonHuy,
    ];
    donTra.value = [
      thongKeHomNay.value.tongSoLuongHoaDonTraHang,
      thongKeTuanNay.value.tongSoLuongHoaDonTraHang,
      thongKeThangNay.value.tongSoLuongHoaDonTraHang,
      thongKeTheoNam.value.tongSoLuongHoaDonTraHang,
    ];
  } catch (error) {
